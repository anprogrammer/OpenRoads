...
(function (Configurations) {
    function runNode() {
        ...
        manager.loadMultiple([
            ...
            managers.Keyboard = new Engine.KeyboardManager(doc);
...
(function (Engine) {
    var FrameManager = (function () {
        function FrameManager(document, canvas, managers, gs, clock) {
            var _this = this;
            this.physicsTime = 0;
            this.states = [];
            this.fps = 0;
            ...
            this.managers = managers;
            document.requestAnimationFrame(function () {
...
(function (Engine) {
    var KeyWatcher = (function () {
        function KeyWatcher(kbd, keyCode, cb) {
            this.enabled = false;
            this.repeating = true;
            this.heldTime = 0;
            this.kbd = kbd;
        ...
        KeyWatcher.prototype.update = function (time) {
...
(function (Game) {
    var CarSprite = (function () {
        ...
        CarSprite.prototype.update = function (state) {
...
(function (Game) {
    var KeyboardController = (function () {
        function KeyboardController(kbd) {
            this.kbd = kbd;
        }
        KeyboardController.prototype.update = function (ship) {
            var turn = 0, accel = 0, jump = false;
            ...
            return new Game.ControllerState(turn, accel, jump);
        };
        KeyboardController.TilePositionToDemoPosition = 0x10000 / 0x666;
...
(function (Managers) {
    var StreamManager = (function () {
        function StreamManager(provider) {
            this.streams = {};
...
(function (States) {
    var ControlsMenu = (function (_super) {
        ...
        ControlsMenu.prototype.load = function (gl) {
            ...
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 37, function () {
                return _this.updateMenu(false);
            }));
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 39, function () {
                return _this.updateMenu(true);
            }));
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 27, function () {
...
(function (States) {
    var GoMenu = (function (_super) {
        ...
        GoMenu.prototype.load = function (gl) {
            ...
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 38, function () {
                return _this.updateLevel(-1);
            }));
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 40, function () {
                return _this.updateLevel(1);
            }));
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 39, function () {
                return _this.updateLevel(15);
            ...
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 13, function () {
                return _this.enterLevel();
            }));
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 32, function () {
                return _this.enterLevel();
            }));
            this.watchers.push(new Engine.KeyWatcher(managers.Keyboard, 27, function () {
        ...
        GoMenu.prototype.drawFrame2D = function (gl, canvas, frameManager, frameTimeInfo) {
            ...
            var dotCountForLevel = function (n) {
                return _this.myManagers.Settings.wonLevelCount(n);
            };
...
(function (Stores) {
    var FSStore = (function () {
        function FSStore() {
            this.filename = 'Data/settings.json';
            this.opts = {};
            this.fs = require('fs');
            try  {
...
(function (WGL) {
    var Shader = (function () {
        ...
        Shader.prototype.getVertexAttribute = function (name) {
            ...
            return attrib !== -1 ? new WGL.VertexAttribute(gl, attrib) : null;
        };
        ...
        Shader.prototype.getUniform = function (name) {
            ...
            return loc !== null ? new WGL.ShaderUniform(gl, loc) : null;
        };
        return Shader;
    })();
    WGL.Shader = Shader;
